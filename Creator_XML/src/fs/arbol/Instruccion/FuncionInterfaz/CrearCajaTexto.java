 ...
 * @author Jhona
 */
public class CrearCajaTexto extends FunNativaInterfaz implements Expresion {
    
    public Controlador componente;
    
    public CrearCajaTexto(LinkedList<Expresion> exps, int line, int colm) {
    ...
    public Object evaluar(Entorno ent) {
        ...
        if(exps.size() == 11)
        {
                    ...
                    && e11.tipo == Operacion.Tipo.CADENA)
            {
                ...
                componente.generarCajaTexto(null);
                
                return new Literal(Operacion.Tipo.CONTROLADOR_TEXTO, componente, line, colm);
            }
            else
            {
