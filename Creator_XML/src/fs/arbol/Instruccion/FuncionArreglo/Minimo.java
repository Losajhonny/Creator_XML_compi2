 ...
 * @author Jhona
 */
public class Minimo extends FunNativaArreglo implements Expresion, Instruccion {
    
    public Minimo(int line, int colm) {
        super(line, colm);
    }
    ...
    public Object execute_numero(Entorno ent, Operacion.Tipo tipo)
    {
    ...
    public Object execute_cadena(Entorno ent, Operacion.Tipo tipo)
    {
    ...
    public Object execute_boolean(Entorno ent, Operacion.Tipo tipo)
    {
    ...
    public Object execute(Entorno ent)
    {
        ...
        if(arr != null)
        {
            if(arr.tam > 0)
            {
                Operacion.Tipo aux = arr.valores.get(0).tipo;
                switch(aux)
                {
                    case ENTERO:
                    case DECIMAL:
        ...
        else
        {
            otros.Error err = new otros.Error(Constante.FS, Constante.EJECUCION, "", ent.ambito,
                    "La funcion nativa MINIMO debe de recibir un arreglo", Constante.archivo, line, colm);
